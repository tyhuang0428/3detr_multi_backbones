...
DATASET_ROOT_DIR = "/data/hty/votenet_scannet/scannet_train_detection_data"  ## Replace with path to dataset
DATASET_METADATA_DIR = "/data/hty/votenet_scannet/meta_data" ## Replace with path to dataset
