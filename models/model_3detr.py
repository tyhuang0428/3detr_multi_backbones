...
from models.mink_unet import MinkUNetBase
from models.dgcnn import DGCNNBackbone
...
def build_encoder(args):
    ...
    elif args.enc_type == 'mink':
        encoder = MinkUNetBase(34, 3, args.preenc_npoints, args.ckpt, planes='C')
    elif args.enc_type == 'dgcnn':
        encoder = DGCNNBackbone(3, args.ckpt)
    elif args.enc_type == 'mae':
        encoder = MAEEncoder(args.ckpt)
    else:
